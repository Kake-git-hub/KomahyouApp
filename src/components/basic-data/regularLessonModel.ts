...
export function createInitialRegularLessons(today = new Date()): RegularLessonRow[] {
  ...
  return [
    ...
    { id: 'r007', schoolYear: currentSchoolYear, teacherId: 't006', student1Id: 's008', subject1: 'IT', startDate: '', endDate: '', student2Id: '', subject2: '', student2StartDate: '', student2EndDate: '', nextStudent1Id: '', nextSubject1: '', nextStudent2Id: '', nextSubject2: '', dayOfWeek: 3, slotNumber: 3 },
    ...
    { id: 'r013', schoolYear: currentSchoolYear, teacherId: 't006', student1Id: 's015', subject1: 'IT', startDate: '', endDate: '', student2Id: '', subject2: '', student2StartDate: '', student2EndDate: '', nextStudent1Id: '', nextSubject1: '', nextStudent2Id: '', nextSubject2: '', dayOfWeek: 5, slotNumber: 3 },
    ...
    { id: 'r021', schoolYear: currentSchoolYear, teacherId: 't006', student1Id: 's024', subject1: 'IT', startDate: '', endDate: '2026-03-31', student2Id: '', subject2: '', student2StartDate: '', student2EndDate: '', nextStudent1Id: '', nextSubject1: '', nextStudent2Id: '', nextSubject2: '', dayOfWeek: 4, slotNumber: 4 },
    ...
    { id: 'r027', schoolYear: currentSchoolYear, teacherId: 't006', student1Id: 's030', subject1: 'IT', startDate: '', endDate: '2026-03-31', student2Id: '', subject2: '', student2StartDate: '', student2EndDate: '', nextStudent1Id: '', nextSubject1: '', nextStudent2Id: '', nextSubject2: '', dayOfWeek: 6, slotNumber: 1 },
    ...
    { id: 'r030', schoolYear: currentSchoolYear + 1, teacherId: 't006', student1Id: 's014', subject1: 'IT', startDate: '', endDate: '', student2Id: '', subject2: '', student2StartDate: '', student2EndDate: '', nextStudent1Id: '', nextSubject1: '', nextStudent2Id: '', nextSubject2: '', dayOfWeek: 4, slotNumber: 4 },
