...
export const VERIFICATION_CHECKLIST_VERSION = 'v1.5.527'
  ...
  items: [
    {
      id: 'b-2',
      area: '基本データ',
      title: '「退塾」ボタンを押すと、その場で在籍の生徒一覧から消える',
      steps: [
        '基本データの生徒タブで、在籍中の生徒の「退塾」を押し「退塾にする」を押す',
        'その生徒がすぐ在籍の一覧から消え、「非在籍生徒表示」を押すと一覧に出る(退塾日は今日の日付)',
        '今日の盤面では、その生徒の今日のコマがそのまま残っている(今日までは在籍扱い)',
        '※ 非在籍一覧の「削除」ボタンは、退塾日の翌日から出る',
      ],
      introducedIn: 'v1.5.527',
    },
  ],
}
