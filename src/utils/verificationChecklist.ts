...
export const VERIFICATION_CHECKLIST_VERSION = 'v1.5.557'
 ...
 *   第23版の項目(b-2/b-3/c-2/t-1/s-4/q-1〜q-6)は結果待ちのまま残す。版は v1.5.557 へ(新機能の追加＝次にデプロイされる版)。
  ...
  items: [
    ...
    },
    {
      ...
      check: [
        ...
        '5 の表で、この確認リスト(v1.5.557)の項目が「未確認」で並び、送信すると次の再読込で OK／要改善に変わる',
