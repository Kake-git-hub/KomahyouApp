...
export const VERIFICATION_CHECKLIST_VERSION = 'v1.5.509'
  ...
  items: [
    {
      id: 'p-3',
      area: 'PDF',
      title: '時限を絞っても講師名がセルに収まる(2 文字・3 文字とも欠けない)',
      steps: ['3コマ×全曜日で出力する', '2 文字の講師名の両端が欠けていない', '3 文字の講師名(白川智 など)が小さくなりすぎず、左端も欠けていない', '生徒名・学年科目もセルに収まっている'],
      introducedIn: 'v1.5.502',
    },
    {
      id: 'p-12',
      area: 'PDF',
      title: '集団行の未設定セルに「＋ 科目を選択」が印字されない',
      steps: ['集団行のある週で出力する(全選択・コマ選択どちらでも)', '科目未設定の日の集団行が空白になっている(オレンジ色の「＋ 科目を選択」が出ていない)', '画面の盤面では従来どおり「＋ 科目を選択」が出る'],
      introducedIn: 'v1.5.509',
    },
  ],
}
