...
<html lang="ja">
  ...
  <body>
    ...
    <script>
      ...
      function normalizeSubjectForStudent(subject, student, referenceDate) { if (subject !== '算' && subject !== '数') return subject; return getPreferredMathSubject(student, referenceDate); }
