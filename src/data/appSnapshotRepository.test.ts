...
function buildClassroomPayload() {
  return {
    ...
    managers: [],
    teachers: [{ id: 't001', name: '田中', email: '', entryDate: '2024-04-01', withdrawDate: '未定', isHidden: false, subjectCapabilities: [], memo: '' }],
    students: [{ id: 's001', name: '生徒A', displayName: '生徒A', email: '', entryDate: '2024-04-01', withdrawDate: '未定', birthDate: '2014-05-01', isHidden: false }],
    regularLessons: [],
    groupLessons: [],
    specialSessions: [],
    autoAssignRules: [],
