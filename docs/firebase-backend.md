...
- 教室追加: Firebase Console で Auth ユーザーを作成し、`members`, `classrooms`, `classroomSnapshots` を追加する
...
### 4. `classroomSnapshots/{classroomId}` を作る
